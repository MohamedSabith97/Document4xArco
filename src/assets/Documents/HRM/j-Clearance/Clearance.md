...
[Clearance Page](https://mohamedsabith97.github.io/Functional_Document_HRM/Clearance.html#clearance)
...
* And this Final settlement amount calculation is differs as per Working category,
   ...
   * 	*(i)* Employee working Type is two category:-
     ...
     * *(ii)*	Employee working or contract period - Number of working Years.
